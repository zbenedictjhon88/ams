    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                <li class="dropdown">
                    <?php $dashArr = array('dashboard', 'bills') ?>
                    ...
                    <ul class="submenu">
                        ...
                        <li><a class="<?php echo $config['ACTIVE_LINK'] == "addTenant" ? "active" : "" ?>" href="<?php echo $config['BASED_URL'] . '/app/staff/addTenant.php' ?>">Bills</a></li>
                    </ul>
                </li>
